		...
		return (
			<div className="flex flex-col items-center justify-center min-h-screen text-gray-300 px-4">
				...
				<CustomButton
					to="/upgrade"
					Tag={Link}
					className="bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 !text-black font-semibold px-6 py-3 rounded-xl shadow hover:opacity-90 transition-all flex items-center"
				>
